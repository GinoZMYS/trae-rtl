...
pre_all #(
    ...
    .DDRC_SCRKBK_WIDTH(DDRC_SCRKBK_WIDTH),
    .RK_NUM(RK_NUM),
    .SC_NUM(SC_NUM)
) pre_all_inst (
    .core_clk(core_clk),
...
bp_if #(
    ...
    .DDRC_PA_CMD_WIDTH(DDRC_PA_CMD_WIDTH),
    .DDRC_PA_PHASE_WIDTH(DDRC_PA_PHASE_WIDTH),
    .DDRC_PA_SCRKBGBK_WIDTH(DDRC_PA_SCRKBGBK_WIDTH),
    .RK_NUM(RK_NUM),
    .SC_NUM(SC_NUM)
) bp_if_inst (
    .core_clk(core_clk),
...
// Other signals
assign core_clk = 1'b0;// TODO : Connect to actual clock
