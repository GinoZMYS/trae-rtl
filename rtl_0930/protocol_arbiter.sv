...
//==============================================================================
    ...
    input    [2**DDRC_RK_WIDTH-1:0]       pre_all_intent_lp,
    input    [2**DDRC_RK_WIDTH-1:0]       pre_all_intent_qos_lp,
...
wire [2**RK_NUM-1:0] pre_all_intent_lp_wide;
wire [2**RK_NUM-1:0] pre_all_intent_qos_lp_wide;
wire [2**DDRC_RK_WIDTH-1:0] pre_all_grant_lp_narrow;
...
assign pa_pre_all_grant = pa_pre_all_grant_wide[0];
assign pa_pre_pb_grant = pa_pre_pb_grant_wide[0];
...
assign preab_req_preall_narrow = preab_req_preall[0];
assign preab_req_qos_preall_narrow = preab_req_qos_preall[0];
assign preab_grant_preall = {{(RK_NUM*SC_NUM-1){1'b0}}, preab_grant_preall_narrow};
...
assign pre_all_intent_lp_wide = {{(2**RK_NUM-2**DDRC_RK_WIDTH){1'b0}}, pre_all_intent_lp};
assign pre_all_intent_qos_lp_wide = {{(2**RK_NUM-2**DDRC_RK_WIDTH){1'b0}}, pre_all_intent_qos_lp};
assign pre_all_grant_lp = pre_all_grant_lp_narrow;

// Signal assignments -  
assign bp_rnkbgbk_0_pa = {DDRC_BGBK_WIDTH*RK_NUM*SC_NUM{1'b0}};
assign bp_rnkbgbk_1_pa = {DDRC_BGBK_WIDTH*RK_NUM*SC_NUM{1'b0}};
...
command_arbiter #(
    ...
    .preab_req_preall(preab_req_preall_narrow),
    .preab_req_qos_preall(preab_req_qos_preall_narrow),
    .preab_grant_preall(preab_grant_preall_narrow),
    ...
    .mrrx_load_h(mrrx_load_h),
    .zq_load_h(zq_load_h),
    .func_type_pre_sb(func_type_pre_sb),
    .clk_en(clk_en),
    .prepb_req_bank_ref(prepb_req_bank_ref),
...
bp_if #(
    ...
    .bq_type_ref(bq_type_ref),
    .bp_bgbk_0_ref(bp_bgbk_0_ref),
    .bp_bgbk_1_ref(bp_bgbk_1_ref),
    .bp_req_pim(backpressure_pim_bp_req_pim_wide),
